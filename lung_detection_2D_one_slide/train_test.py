...
def test(cfg: dict, args):
    ...
    checkpoint_in_channels = checkpoint_data.get("in_channels")
    if checkpoint_in_channels is None:
        checkpoint_in_channels = ckpt["model"]["backbone.stem.conv.weight"].shape[1]
